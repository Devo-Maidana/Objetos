...
//BORRAR un vehiculo
public borrarAuto(autoParam:Auto):void{


    console.log("el vehiculo esta Borrado");
...
public actualizarAuto(autoParam:Auto):void{
    
console.log("el vehiculo se actualizo");
}



//DAR DE ALTA un vehiculo
public altaAuto(autoParam:Auto):void{
    
    console.log("el vehiculo esta dado de alta");
}
