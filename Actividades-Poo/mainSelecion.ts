...
import { IntegranteSelecion } from 
'./integranteSelecion';

let Primerfutbolista:Futbolista = new Futbolista("Leo", "Messi", 1010,"6-24-1987");
let Segundofutbolista:Futbolista = new Futbolista("Cristiano", "Ronaldo", 9999,"7-25-1985");

console.log(Primerfutbolista.getjugarPartido());
console.log(Primerfutbolista.getFechaNac());
console.log(Segundofutbolista.getEntrenar());
...
console.log(PrimerMasajista.getdarMasaje());
